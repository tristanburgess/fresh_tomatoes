      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          ...
          <div class="navbar-header navbar-right">
            <a class="navbar-brand" href="https://www.linkedin.com/in/tristanburgess1">Created By: Tristan Burgess</a>
          </div>
        </div>
      </div>
    </div>
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        actorListString = ', '.join(movie.actors)
...
def extract_youtube_id(url): 
    ...
    Args:
        url: A string representing the URL to a Youtube movie trailer.

    Returns:
        The Youtube video ID if parsed out successfully, otherwise None.
    """
